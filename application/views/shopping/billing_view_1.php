						            ...
						            <form name="billing" method="post" action="<?php echo base_url() . 'shopping/save_order' ?>" >
						                ...
						                <div align="center">
						                    ...
						                    <table border="0" cellpadding="2px">
						                     <tr>
						                        <td>Total Productos:</td><td><strong>$<?php echo $this->cart->total_items(); ?></strong></td></tr>
						                        <tr>
						                        <td>Order Total:</td><td><strong>$<?php echo number_format($grand_total, 2); ?></strong></td></tr>
						                        ...
						                        echo "<a class ='fg-button teal' id='back' href=" . base_url() . "shopping>Regresar</a>";  ?>
						                            </td><td><input type="submit" class ='fg-button teal' value="Procesar Pedido" /></td></tr> 
