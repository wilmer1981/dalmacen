	...
	<div class="col-sm-3 sin-spacio">
		...
		<div class="col-sm-9">
			<div class="panel-group border-containt">
				<div class="panel panel-primary">
					<div class="panel-heading heading-text">
					<?php echo "SOLICITUD DE COTIZACION"; ?></div>
					<div class="panel-body panel-width container-fondo">

						<div class="row">
							<div class="col-lg-12 col-sm-6">
							      <div id='result_div'>
								    <h1 align="center">¡Gracias! ¡Su requerimiento fue enviado correctamente!</h1>
								    <span id="go_back"><a class='fg-button teal' href="<?php echo base_url(); ?>"Shopping>Go back</a></span>
