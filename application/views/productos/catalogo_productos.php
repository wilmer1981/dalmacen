			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-9 col-md-9 padding-right">	
					...
					<div class="features_items">
						...
						<h2 class="title text-center">Productos : <?php echo $titulo; ?></h2>
						<?php
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<h2><?php echo "S/ ".$precio; ?></h2>
											<p><?php echo $titu; ?></p>
											<a href="<?php echo base_url('productos/preview/'.$url1); ?>" class="btn btn-default add-to-cart"><i class="fa fa-search-plus"></i>Ver detalle</a>
										</div>
