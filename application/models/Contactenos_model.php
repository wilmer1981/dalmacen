...
class Contactenos_model extends CI_Model {
    ...
    public function add_cotizacion($nom, $cor, $tel, $idp) {
		...
		return $this->db->insert('wsoft_cotizacion', $data);
		
	}

	  public function add_suscripcion($email) {
		...
		return $this->db->insert('wsoft_subscribers', $data);
