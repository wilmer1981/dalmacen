...
class Maquinas_model extends CI_Model {
    ...
    public function sp_getSubCategorias(){	     
     ...
     public function sp_getSubCategoriasCatalogo($idcat,$one=false,$array='array'){	     
	    $sql="CALL sp_getSubCategoriasCatalogo(?)";
	    $parameters=array($idcat);
    ...
    public function sp_getBreadcrumbs($id,$opc){	     
	    $sql="CALL sp_getBreadcrumbs(?,?)";
		$parameters = array($id,$opc);
    ...
    public function count($table,$where) {
     ...
     public function counts($table,$idcol,$where) {
    	$this->db->from($table);  
