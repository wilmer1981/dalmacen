...
*/
    ...
    public function getEmpleados($where='',$perpage=0,$start=0,$one=false,$array='array'){
        
        $this->db->select('e.*, p.nombre as permiso,u.estado as status,u.nivel');
        $this->db->from('usuarios as u');
		$this->db->join('empleados as e', 'e.id = u.id_empleado', 'inner');
       	$this->db->join('permisos as p', 'p.idpermiso = u.permisos_id', 'inner');
