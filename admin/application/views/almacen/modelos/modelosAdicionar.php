    <div class="box box-default">
                <div class="box-header with-border">
                  <h3 class="box-title"><span class="icon"><i class="fa fa-user-plus" aria-hidden="true"></i> Registrar Modelo</span></h3>
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                      <div class="form-group has-success">
                                        ...
                                        <select id="cboMarca" name="cboMarca" class="form-control">
                                    		<?php foreach ($marcas as $t) {
													  echo '<option value="'.$t->id.'">'.strtoupper($t->nombre).'</option>';
											} ?>
                                      ...
                                      <div class="form-group has-success">
                                          ...
                                          <input id="txtNombre" type="text" maxlength="50" name="txtNombre" required="" class="form-control" placeholder="Ingrese modelo" autofocus="">
                                      </div>
                                  </div>
