...
<div class="page-content">
	<div class="page-header">
		<h1>Gestión
			<small><i class="ace-icon fa fa-angle-double-right"></i> Categorias</small>
		</h1>
		...
		<?php if(empty($idcat)){ ?>	
		<a href="<?php echo base_url('productos/addcategory');?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a>
		<?php }else{ ?>	
		<a href="<?php echo base_url('productos/addcategory/'.$idcat);?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a>
		<?php } ?>	
			<!--
		...
		<button type="button" data-toggle="tooltip" title="" class="btn btn-danger btn_deletecategory" data-original-title="Delete"><i class="fa fa-trash-o"></i></button>
		</div>
	...
	-->
  	...
  	<div class="row">
		...
		<!--
		   <div class="clearfix">
				<div class="pull-right tableCategoryTools-container"></div>
			</div>
-->		
			<div>
              ...
              <tbody>
                                <?php foreach ($categorias as $r) {   
                                 ...
                                 if($r->estado==1){
                                    ...
                                    $count = getCountItems("wsoft_categorias","id_categoria='".$r->id."'"); 
			         ...
			         $this->permission->checkPermission($this->session->userdata('permiso'),'mPex')){
									    ...
									    echo '<a class="green" href="'.base_url('productos/updatecategory/'.$r->id).'">
