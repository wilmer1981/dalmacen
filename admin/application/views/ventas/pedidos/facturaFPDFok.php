...
*/
          ...
          //  $this->SetXY(15, 50);
           ...
           // $this->setFillColor(255,255,255);
            ...
            $this->SetXY(12, 40);
            $this->cell(35,6,"             ".$pedido[0]->cliente,0,1,'L',0); //cliente

            $this->SetXY(12, 45);
            $this->cell(35,6,"             ".$pedido[0]->direccion,0,1,'L',0); 
            ...
            $this->SetXY(12, 50);
            $this->cell(35,6,'             '.$pedido[0]->num_documento,0,1,'L',0);  
           ...
           // $this->Rect(140, 45, 60, 20, 'D');      
            ...
            $this->setFont('Arial','',10);
            $this->SetXY(160, 40);
            $this->cell(35,6,"                    ",0,1,'L',0); //forma pago

            $this->SetXY(160, 45);
            $this->cell(35,6,"                    ",0,1,'L',0); //venbdedor
     
            $this->SetXY(160, 50);
            $this->cell(35,6,'                    ',0,1,'L',0);  //numero guia
           // $this->Cell(220,15,"ORDEN DE COMPRA",0,0,'C');             
            $this->SetXY(160, 55);
            $this->cell(35,6,'                    '.date('d/m/Y',  strtotime($pedido[0]->fech_reg)),0,1,'L',0); 
                   ...
                   // $this->SetWidths(array(10,10,15,118,20,20),0); 
                    foreach ($pedidoitems as $key){ 
                               $this->SetX(5);
                                ...
                                $this->Cell(10,6,$key->cantidad,0,0,'C',0);							 
                                $this->Cell(10,6,$key->unidad,0,0,'L',0);
                                $this->Cell(15,6,$key->cod_producto,0,0,'L',0);   
								$this->Cell(120,6,$product,0,0,'J',0);                           					 
                    ...
                    $this->Cell(20,7,'          ',0,0,'R',1);     //SUBTOTAL                        
                    $this->Cell(20,7,"$ ".number_format($SUBTOTAL - $pedido[0]->impuesto_total,2),0,0,'R',0); 

                    $this->SetXY(15, 144);
                    $this->Cell(145,7,'',0,0,'C',0);  
                    $this->Cell(20,7,'    18    ',0,0,'R',1); //IGV                  
                    $this->Cell(20,7,"$ ".number_format($pedido[0]->impuesto_total,2),0,0,'R',0);  

                    $this->SetXY(15, 151);
                    $this->Cell(145,7,'',0,0,'C',0);   
                    $this->Cell(20,7,'          ',0,0,'R',1);  //TOTAL                           
