<div class="box box-default">
  ...
  <div class="box-header with-border">
    <h3 class="box-title"><span class="icon"><i class="fa fa-plus-square" aria-hidden="true"></i> ORDEN DE COMPRA / DETALLES</span></h3>
                         ...
                         <table class="table table-bordered">                    
                          <tbody>
                            ...
                            <tr>
                              ...
                              <th scope="row" class="active">FECHA ORDEN</th>
