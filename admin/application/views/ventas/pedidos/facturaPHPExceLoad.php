...
$objTpl = PHPExcel_IOFactory::load("factura.xlsx");
...
////////////////////////////////////////////////////////////////////////////////
            ...
            $objTpl->getActiveSheet()->setCellValue('E8', $direccion);
            $objTpl->getActiveSheet()->setCellValue('E9', $pedido[0]->num_documento);
            $objTpl->getActiveSheet()->setCellValue('E10', $pedido[0]->tipoprecio);


            if($pedido[0]->tipo_pago=='CRE') {$formapago="CREDITO";  }else{ $formapago="CONTADO"; }
            $objTpl->getActiveSheet()->setCellValue('AA7', $formapago);
...
///////////////////////////////////////////////////////////////////////////////
                ...
                foreach ($pedidoitems as $key){ 
                   ...
                   // $importe = number_format($key->precio_venta * $key->cantidad,2); 
                    ...
                    $objTpl->getActiveSheet()->setCellValue('E'.$fila, $key->cod_producto);  
                    $objTpl->getActiveSheet()->setCellValue('H'.$fila, $product);   
...
$filename='facturass.xlsx'; //just some random filename
