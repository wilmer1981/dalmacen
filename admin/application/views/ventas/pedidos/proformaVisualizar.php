<div class="box box-default">
  ...
  <div class="box-header with-border">
    <h3 class="box-title"><span class="icon"><i class="fa fa-plus-square" aria-hidden="true"></i> PROFORMA / DETALLES</span></h3>
                  ...
                  <div class="row">             
                      <div class="col-md-12">
                         <table class="table table-bordered">                    
                          <tbody>
                             <tr>
                              <th scope="row" class="active"># PROFORMA</th>
                              <td><?php 
                              if($DocOrder[0]->id_tipocomprobante==10 ){ //si es factura
                                  //echo $DocOrder[0]->serie_comprobante.' - '.$DocOrder[0]->num_pedido; 
                                  echo $DocOrder[0]->num_pedido; 
                              }
                            ...
                            <tr>
                              ...
                              <th scope="row" class="active">FECHA PROFORMA</th>
