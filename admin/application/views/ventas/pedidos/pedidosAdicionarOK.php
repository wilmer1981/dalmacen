                                ...
                                <div class="form-group has-success">
                                  ...
                                  <div class="input-group has-success">
                                    ...
                                    <span class="input-group-btn">
                                      ...
                                      <button type="button" class="btn btn-primary" id="btnRegisterCliente" title="Agregar Cliente" data-toggle="modal" data-target="#modal_form_register"><i class="fa fa-user-plus" aria-hidden="true"></i></button>                               
                                    </span>
                                  </div>   
                                </div>            
                            </div>        
