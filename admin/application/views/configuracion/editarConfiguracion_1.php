                                                ...
                                                <div id="home" class="tab-pane fade in active">
                                                       <form role="form" name="frmGlobal" id="frmGlobal" enctype="multipart/form-data" action="Configuraciones/editar" method="post">
														<div class="row">
																  ...
																  <div class="row">
																	  <div class="col-xs-6">
																		  <div class="form-group has-success">
																				...
																				<input id="txtEmpresa" type="text" maxlength="100" class="form-control" name="txtEmpresa" required="" placeholder="Ingrese el nombre de la empresa" autofocus="" value="<?php echo $configuracion[0]->empresa; ?>">
																		  </div>
																	  </div>
																	  <div class="col-xs-6">
																		<div class="form-group has-success">
																		  <label for="inputMarca">RUC:</label>
																			<input id="txtRuc" type="text" maxlength="11" class="form-control" name="txtRuc" required="" placeholder="Ingrese numero de RUC" value="<?php echo $configuracion[0]->ruc; ?>">
																		</div>
																	  </div>
															...
															<div class="col-lg-12 left">
																<div class="row">
																	<div class="col-xs-6">
																		<div class="form-group has-success">
																			...
																			<input id="txtDireccion" type="text" maxlength="5" class="form-control" name="txtDireccion" required="" placeholder="Direcion de la empresa" value="<?php echo $configuracion[0]->direccion; ?>">
																		</div>
																	</div>
																	<div class="col-xs-6">
																		<div class="form-group has-success">
																			<label for="inputMarca">Telefono:</label>
																			<input id="txtTelefono" type="number" class="form-control" name="txtTelefono" required="" placeholder="Numero de telefono de la empresa" value="<?php echo $configuracion[0]->telefono; ?>">
																		</div>
																	</div>
															 ...
															 <div class="col-lg-12 left">
																<div class="row">              
																	<div class="col-xs-6">
																		<div class="form-group has-success">
																			<label for="inputMarca">Logo:</label>
																			<!--
																			<input id="imagenGlobal" type="file" class="form-control" name="imagenGlobal" autofocus="">
																			-->
																			...
																			<input id="txtRutaImgLogo" type="text" class="form-control" name="txtRutaImgLogo" value="<?php echo $configuracion[0]->url_imagen; ?>">
																		</div>
																	</div>
															...
															<div class="col-lg-12 left">
																<h5></h5>
																<a href="<?php echo base_url(); ?>" class="btn btn-white btn-default btn-round"><i class="ace-icon fa fa-times red2"></i>Cancelar</a>
															   
																<!--
																<button class="btn btn-success editar-config" type="buttton"><i class="fa fa-floppy-o"></i> Editar</button>
																 <button class="btn btn-white btn-default btn-round">
																<i class="ace-icon fa fa-times red2"></i>Cancel
																</button>
																-->
																<input id="txtIdEmpresa" type="hidden" class="form-control" name="txtIdEmpresa" value="<?php echo $configuracion[0]->id; ?>">
																
																<button class="btn btn-white btn-success btn-round" type="submit"><i class="fa fa-floppy-o"></i> Grabar</button>
