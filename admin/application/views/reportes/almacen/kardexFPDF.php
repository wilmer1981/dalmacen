...
class PDF extends FPDF{
    ...
    var $aligns;
        ...
        function Cabecera($mes,$anio,$usuario){
           ...
           //$this->SetFillColor(0, 128, 0);
            ...
            $this->Cell(25, 6, 'REPORTE DE KARDEX', 0 , 1);
            ...
            $this->Cell(105, 6, 'REPORTE DE SALDOS Y MOVIMIENTOS',1,0,'J',0);
            $this->SetXY(10, 51);
		...
		function Content($saldos)
        {
                    ...
                    $this->SetWidths(array(15,65,30,20,20,20,20));
                    $this->SetAligns(array('L','C','C','C','C','C','C'));
                    for($i=0;$i<1;$i++) 
                    { 
                        $this->Row(array('CODIGO','PRODUCTO','CATEGORIA','SALDO INICIAL','ENTRADAS','SALIDAS','SALDO'));
                    }				 
					//$this->Ln(6);					
                    $totales=0;
                    ...
                    foreach ($saldos as $r){
                        ...
                        $this->SetAligns(array('L','L','L','C','C','C','C'));
                            ...
                            $this->Row(array($r->cod_producto, utf8_decode($r->producto), $r->categoria, $r->saldo_inicial, $r->entrada, $r->salida, $r->stock));                            
...
$pdf->Output('reporteKardex.pdf', 'F');
