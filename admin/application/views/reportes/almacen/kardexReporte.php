<div class="box box-default">
	<div class="box-header with-border">
		<h3 class="box-title"><span class="icon"><i class="fa fa-users" aria-hidden="true"></i> Reporte Saldos y Movimientos</span></h3>
      ...
      <div class="col-md-12">     
        <div class="form-action" id="buscador">
          ...
          <?php 
            ...
            echo form_open("reportes/almacenkardex", $attr);
          ?>
            <div class="row">
              <div class="col-md-3">
                            ...
                            <tbody>
                                ...
                                foreach ($saldos as $r) { 
                                  ...
                                  if($r->estado==1){
                                    ...
                                    echo '<td><span style="font-weight: bold;">'.$r->saldo_inicial.'</span></td>';
                                    echo '<td><span style="font-weight: bold;">'.$r->entrada.'</span></td>';
                                    echo '<td><span style="font-weight: bold;">'.$r->salida.'</span></td>';
