<section class="content-header">
    ...
    <div class="container">
        ...
        <table id="tableuser" class="table table-bordered table-hover display" cellspacing="0" width="100%">  
            <thead>
                <tr>
                    <th>No</th>
                    <th>First Name</th>
...
<section class="content">
    ...
    <div class="box box-default">
                ...
                <div class="box-body">
                        ...
                        <!--
                        <table id="userlista" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        -->
                        <!--
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered dataTable no-footer" id="userlista" width="100%" role="grid" aria-describedby="067ebf7f-8fb8-11e6-b3d9-002590dcfa5d_info" style="width: 100%;">
                        -->
                         <table id="userlista" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Nombre</th>
