			...
			<div  class="row">	
				<div  class="col-md-6">	
					<div class="form-group">
						...
						<div class="controls">
						  <input id="txtTitulo" type="text" maxlength="100" name="txtTitulo" required="" class="form-control" placeholder="Ingrese nombre del banner" autofocus="" value="<?php echo $banners[0]->titulo; ?>">
						</div>
					</div>								
				...
				<div  class="col-md-3">
					<div class="form-group">
						...
						<div class="controls">
						  <input id="txtAlias" type="text" maxlength="100" name="txtAlias" class="form-control" placeholder="Autogenerar desde el título" value="<?php echo $banners[0]->alias; ?>" readonly>
						</div>
					</div>					
						...
						<div  class="row">	
							<div class="col-md-8">
								  <div class="form-group has-success">
								    ...
								    <input id="imagenBanner" type="file" class="form-control filestyle" name="imagenBanner" autofocus="" data-placeholder="Seleccione imagen" data-buttonText="Buscar imagen" data-buttonName="btn-success" data-buttonBefore="true" data-size="md">
									<input id="txtRutaImg" type="text" class="form-control" name="txtRutaImg" value="<?php echo $banners[0]->url_imagen; ?>" readonly>		
								  </div>
								  <div class="control-group ">
										<label class="control-label">Descripcion :<span class="required"></span></label>
										<div class="controls">
											<textarea name="txtDescripcion" id="txtDescripcion" rows="20" class="form-control" type="textarea"  ><?php echo $banners[0]->descripcion; ?></textarea>
						...
						<div  class="row">	
							<div class="col-md-8">					
								<div class="form-group">
									...
									<div class="col-md-6">
									<input id="txtFechini" type="date" maxlength="150" name="txtFechIni" class="form-control" value="<?php echo $banners[0]->fech_ini; ?>">
									</div>
								</div>
								 <div class="form-group">
									<label class="control-label col-md-4" for="inputMarca">Finalizar publicacion:</label>
									<div class="col-md-6">
									<input id="txtFechFin" type="date" maxlength="150" name="txtFechFin" class="form-control" value="<?php echo $banners[0]->fech_fin; ?>">
									</div>
								</div>
								 <div class="form-group">
									<label class="control-label col-md-4" for="inputMarca">Fecha Creacion:</label>
									<div class="col-md-6">
									<input id="txtFechReg" type="date" maxlength="150" name="txtFechReg" class="form-control" value="<?php echo $banners[0]->fech_reg; ?>" >
									</div>
								</div>
							</div>
						</div>
