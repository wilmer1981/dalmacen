  ...
  <div class="modal-content">
		<div class="modal-header">
             <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <span class="icon"><i class="fa fa-users" aria-hidden="true"></i> Articulos</span>
		</div>  
            ...
            <table id="empleadoslista" class="table table-bordered table-striped" role="grid">
                            ...
                            <tbody>
                                <?php foreach ($articulos as $r) {                    
									...
									<input type="hidden" id="empleado<?php echo $r->id;?>"   value="<?php echo $r->titulo;?>">
																	<?php    
									echo '<a style="margin-right: 1%" class="btn  btn-default btn-xs close-modal" title="Agregar Articulo" data-id="'. $r->id.'"><i class="glyphicon glyphicon-saved"></i></a>'; 
