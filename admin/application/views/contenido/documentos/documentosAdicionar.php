    <div class="box box-default">
                <div class="box-header with-border">
                  <h3 class="box-title"><span class="icon"><i class="fa fa-clipboard" aria-hidden="true"></i> Registrar Documento</span></h3>
                              ...
                              <div class="row">
                                  <div class="col-xs-6">
                                      <div class="form-group has-success">
                                          ...
                                          <input id="txtNombre" type="text" maxlength="50" name="txtNombre" required="" class="form-control" placeholder="Nombre" autofocus="">
                                      </div>
                                  </div>
                                  <div class="col-xs-6">
                                      <div class="form-group has-success">
                                          ...
                                          <select class="form-control" name="cboOperacion" id="cboOperacion">
                                              ...
                                              <?php foreach ($documentostipo as $t) {
                                                ...
                                                echo '<option value="'.$t->sigla.'" >'.$documento.'</option>';
                                              } ?>
                                          </select>  
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group has-success">
                                          ...
                                          <input id="txtSerie" type="text" maxlength="50" name="txtSerie" required="" class="form-control" placeholder="Serie">
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="form-group has-success">
                                          <label for="inputMarca">Numero:</label>
                                          <input id="txtNumero" type="text" maxlength="50" name="txtNumero" required="" class="form-control" placeholder="Numero Correlativo">
                                      </div>
                                  </div>
