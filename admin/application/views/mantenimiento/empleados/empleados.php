<div class="page-content">
	<div class="page-header">
		<h1>Gestor
			<small><i class="ace-icon fa fa-angle-double-right"></i> Usuarios</small>
		</h1>
	...
	<div class="row">
		<div class="col-md-12">
		   ...
		   <div class="clearfix">
			...
			<div>		
			<form role="form" name="form-users" id="form-users" method="post" >						
					...
					echo '<td>'.$estado.'</td>';
				     echo '<td>';
                              echo '<div class="hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="green" href="'.base_url('usuarios/editar/'.$r->id).'">
