									...
									<div class="row">
										  <div class="col-md-12">
											  <div class="form-group required">
												  ...
												  <input id="txtTitulo" type="text" name="txtTitulo" required="" class="form-control" placeholder="Nombre grupo" autofocus="" value="<?php echo $registro[0]->titulo;?>">
										...
										<div class="control-group ">
											...
											<div class="controls">
												<div class="btn-group" data-toggle="buttons-radio">
												   ...
												   <label class="radio-inline"><input type="radio" id="rdoStatus" name="rdoStatus" value="0"<?php if($registro[0]->estado=='0'){ echo "checked=true";}else{ echo "";}?>> Desactivado</label>
												</div>
											</div>
										</div>
									</div>		
