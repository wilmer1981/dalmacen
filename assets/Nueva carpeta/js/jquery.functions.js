var xD={
	all:{
		vars:function(){
			xD.l1=['index','shopping','productos','registros','archivos','contratos','empleados','usuarios','login'];
			xD.l2='/api?callback=?';
	...
	login:{
		...
		confirm_login_in:function(str){
			$.ajax({
					...
					success: function(data){
						console.log();
						if(data.resultado == 'ok' && data.cart > 0){
						...
						}else if(data.resultado == 'ok' && data.cart < 1){
							//$('.viewport_progress').html('<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>¡Importante!</strong><small>'+ data.resultado +'</small></div>'); // Mostramos los valores devueltos por el php
								setTimeout( function() {  //redirige a la pagina padre
		...
		validaRegister:function(){	
			if($("#formRegister #txtNombre").val() == "" ){
				$("#formRegister #txtNombre").focus();	
				$('.viewport_progress_reg').show();	
				$('.viewport_progress_reg').html('<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>¡Error!</strong><small> Ingrese su nombre.</small></div>'); // Mostramos los valores devueltos por el php
				setTimeout( function() {				
						$('.viewport_progress_reg').hide();					
				}, 2000 );
				return false;							
			}else if($("#formRegister #txtEmail").val() == "" ){
				$("#formRegister #txtEmail").focus();	
				$('.viewport_progress_reg').show();	
				$('.viewport_progress_reg').html('<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>¡Error!</strong><small> Ingrese E-mail.</small></div>'); // Mostramos los valores devueltos por el php
				setTimeout( function() {				
						$('.viewport_progress_reg').hide();					
				}, 2000 );
				return false;							
			}else if(xD.all.IsEmail($("#formRegister #txtEmail").val())==false){
				$("#formRegister #txtEmail").focus();	
				$('.viewport_progress_reg').show();	
				$('.viewport_progress_reg').html('<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>¡Error!</strong><small> Ingrese E-mail valido.</small></div>'); // Mostramos los valores devueltos por el php
				setTimeout( function() {				
						$('.viewport_progress_reg').hide();					
				}, 2000 );
				return false;
				...
				$('.viewport_progress_reg').show();	
				$('.viewport_progress_reg').html('<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>¡Error!</strong><small> Ingrese Contraseña.</small></div>'); // Mostramos los valores devueltos por el php
				setTimeout( function() {				
						$('.viewport_progress_reg').hide();					
				}, 2000 );
				return false;
		...
		confirm_user_register:function(str){
			$.ajax({
					...
					success: function(data){
						console.log();
						if(data.resultado == 'ok' && data.cart > 0){
								$('.viewport_progress_reg').html('<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>¡Importante!</strong><small>'+ data.message +'</small></div>'); // Mostramos los valores devueltos por el php
								setTimeout( function() {  //redirige a la pagina padre
									window.location = BASE_URL + "shopping/checkout";				
							}, 1000 );
						}else if(data.resultado == 'ok' && data.cart < 1){
							...
							$('.viewport_progress_reg').html('<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>¡Error!</strong><small>'+ data.message +'</small></div>'); // Mostramos los valores devueltos por el php
				...
				$.ajax({
						...
						success: function(response){
							...
							if(response.success == 0) {								
								...
								/*console.log();
								if(data.resultado == 'ok'){
									$('.resultado').html('<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>¡Importante!</strong><small>'+ data.resultado +'</small></div>'); // Mostramos los valores devueltos por el php
									setTimeout( function() {  //redirige a la pagina padre
										//window.location = "index.php?index.php/user/get_users"; // redirige a la pagina USERS
										window.location = BASE_URL;
									...
									$('.resultado').html('<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>¡Importante!</strong><small>'+ data.message +'</small></div>'); // Mostramos los valores devueltos por el php
